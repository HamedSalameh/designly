...
namespace Projects.Tests
{
    ...
    public class ProjectId_Tests
    {
        ...
        {
            // Arrange
            var id1 = new ProjectId(Guid.NewGuid());
            var id2 = new ProjectId(id1.Id);
        ...
        public void CompareTo_ShouldReturnZegative_WhenIdsNotEqual()
        {
            // Arrange
            var id1 = new ProjectId(Guid.NewGuid());
            var id2 = new ProjectId(Guid.NewGuid());
        ...
        {
            var taskItemId1 = new ProjectId(new Guid("12345678-1234-1234-1234-123456789012"));
            var taskItemId2 = new ProjectId(new Guid("12345678-1234-1234-1234-123456789013"));
        ...
        {
            var taskItemId1 = new ProjectId(new Guid("12345678-1234-1234-1234-123456789013"));
            var taskItemId2 = new ProjectId(new Guid("12345678-1234-1234-1234-123456789012"));
