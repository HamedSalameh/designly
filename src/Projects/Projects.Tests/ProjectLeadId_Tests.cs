...
{
    [TestFixture]
    public class ProjectLeadId_Tests
    {
        ...
        {
            // Arrange
            var id1 = new ProjectLeadId(Guid.NewGuid());
            var id2 = new ProjectLeadId(id1.Id);
        ...
        public void CompareTo_ShouldReturnZegative_WhenIdsNotEqual()
        {
            // Arrange
            var id1 = new ProjectLeadId(Guid.NewGuid());
            var id2 = new ProjectLeadId(Guid.NewGuid());
        ...
        {
            var taskItemId1 = new ProjectLeadId(new Guid("12345678-1234-1234-1234-123456789012"));
            var taskItemId2 = new ProjectLeadId(new Guid("12345678-1234-1234-1234-123456789013"));
        ...
        {
            var taskItemId1 = new ProjectLeadId(new Guid("12345678-1234-1234-1234-123456789013"));
            var taskItemId2 = new ProjectLeadId(new Guid("12345678-1234-1234-1234-123456789012"));
