...
namespace Projects.Tests
{
    ...
    public class TaskItemId_Tests
    {
        ...
        {
            // Arrange
            var id1 = new TaskItemId(Guid.NewGuid());
            var id2 = new TaskItemId(id1.Id);
        ...
        public void CompareTo_ShouldReturnZegative_WhenIdsNotEqual()
        {
            // Arrange
            var id1 = new TaskItemId(Guid.NewGuid());
            var id2 = new TaskItemId(Guid.NewGuid());
        ...
        {
            var taskItemId1 = new TaskItemId(new Guid("12345678-1234-1234-1234-123456789012"));
            var taskItemId2 = new TaskItemId(new Guid("12345678-1234-1234-1234-123456789013"));
        ...
        {
            var taskItemId1 = new TaskItemId(new Guid("12345678-1234-1234-1234-123456789013"));
            var taskItemId2 = new TaskItemId(new Guid("12345678-1234-1234-1234-123456789012"));
