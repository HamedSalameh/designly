export class Strings {
  ...
  static UnableToLoadProjectsList = $localize`:@@Errors.Project.UnableToLoadProjects:We were unable to load the projects list. Please try again.`;
  static UnableToLoadAccountUsers = $localize`:@@Errors.User.UnableToLoadUsers:We were unable to load the users list. Please try again.`;
